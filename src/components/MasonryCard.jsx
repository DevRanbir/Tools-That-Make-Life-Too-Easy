...
export function MasonryCard({ item, imageHeight, handleMouseEnter, handleMouseLeave, disableMorph }) {
    ...
    const CardContent = (
        <div
            className="group relative flex h-full w-full flex-col justify-between rounded-xl border border-border bg-card p-5 transition-all hover:border-ring shadow-sm hover:shadow-md"
