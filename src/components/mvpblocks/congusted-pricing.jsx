...
const defaultPlans = [
  {
    name: "STARTER",
    price: "50",
    //... (keeping defaultPlans for backward compatibility or default usage)
...
export default function CongustedPricing({
  plans = defaultPlans,
          ...
          <label className="relative inline-flex cursor-pointer items-center">
            <Label>
              <Switch
                ...
                className="relative data-[state=unchecked]:bg-zinc-700"
              />
            </Label>
          </label>
      ...
      <div className="sm:2 grid grid-cols-1 gap-4 md:grid-cols-3">
        {plans.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              `bg-card relative rounded-2xl border-[1px] p-6 text-center lg:flex lg:flex-col lg:justify-center`,
            ...
            {plan.isPopular && (
              <div className="bg-primary absolute top-0 right-0 flex items-center rounded-tr-2xl rounded-bl-xl px-3 py-1">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <p className="text-muted-foreground text-xs leading-5">
                {plan.period === "one-time" ? "Pay once, yours forever" : (isMonthly ? "billed monthly" : "billed annually")}
              </p>
